...
class Payload(Shellcode):
    ...
    Shellcode.info["name"] = "Bind TCP Stager (Stage 1)"
    ...
    def sld(self):
        ...
        Shellcode.info["payload"] = EncoderModule(self.customized_shellcode).do_the_magic()
        #print EncoderModule(self.customized_shellcode).do_the_magic()
